...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    Counter: function Counter(t0, t1, t2, t3, t4, t5, t6, t7, t8) {
      var _ = this;
      _.name = t0;
      _._modules = t1;
    ...
    _Wire_inject_closure: function _Wire_inject_closure(t0, t1, t2) {
      this.$this = t0;
      this.val = t1;
      this.fill = t2;
    },
    ...
    main$body(noPrint) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        val, nextVal, t4, t5, t6, t7, en, reset, clk, t1, t2, t3, counter, en0, reset0;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              en = A.Logic$("en", 1);
              reset = A.Logic$("reset", 1);
              clk = A.SimpleClockGenerator$(10).output$1("clk");
              t1 = type$.Module;
              t2 = type$.Logic;
              t3 = type$.String;
              counter = new A.Counter("counter", A.LinkedHashSet_LinkedHashSet$_empty(t1), A.LinkedHashSet_LinkedHashSet$_empty(t2), A.LinkedHashMap_LinkedHashMap$_empty(t3, t2), A.LinkedHashMap_LinkedHashMap$_empty(t3, t2), "counter", false, null, false);
              en0 = counter.addInput$2("en", en);
              reset0 = counter.addInput$2("reset", reset);
              clk = counter.addInput$2("clk", clk);
              val = counter.addOutput$2$width("val", 8);
              nextVal = A.Logic$("nextVal", 8);
              t4 = A.Add$(val, 1);
              t5 = t4.___TwoInputBitwiseGate__outName_F;
              t5 === $ && A.throwLateFieldNI("_outName");
              nextVal.gets$1(t4.output$1(t5));
              t5 = type$.JSArray_Conditional;
              t4 = A._setArrayType([val.$lt(0, 0)], t5);
              t5 = A._setArrayType([A.If$(reset0, A._setArrayType([A.If$(en0, B.List_empty, A._setArrayType([val.$lt(0, nextVal)], t5))], t5), t4)], t5);
              t4 = type$.JSArray_Logic;
              reset0 = A._setArrayType([clk], t4);
              t4 = A._setArrayType([], t4);
              t6 = A._setArrayType([], type$.JSArray_nullable_LogicValue);
              t7 = A.Uniquifier$(null);
              t2 = new A.Sequential(t4, A.LinkedHashMap_LinkedHashMap$_empty(t2, type$.LogicValue), t6, A.LinkedHashSet_LinkedHashSet$_empty(t2), t5, A.LinkedHashMap_LinkedHashMap$_empty(t2, t2), A.LinkedHashMap_LinkedHashMap$_empty(t2, t2), t7, "sequential", A.LinkedHashSet_LinkedHashSet$_empty(t1), A.LinkedHashSet_LinkedHashSet$_empty(t2), A.LinkedHashMap_LinkedHashMap$_empty(t3, t2), A.LinkedHashMap_LinkedHashMap$_empty(t3, t2), "sequential", false, null, false);
              t2._Always$2$name(t5, "sequential");
              t2.Sequential$multi$3$name(reset0, t5, "sequential");
              $async$goto = 2;
              return A._asyncAwait(counter.build$0(), $async$main);
            case 2:
              // returning from await.
              if (!counter._hasBuilt)
                A.throwExpression(A.Exception_Exception("Module has not yet built!  Must call build() first."));
              t2 = new A.DateTime(Date.now(), false).toString$0(0);
              t4 = new A.SystemVerilogSynthesizer();
              t3 = new A.SynthBuilder(counter, t4, A.LinkedHashMap_LinkedHashMap$_empty(t1, t3), A.LinkedHashSet_LinkedHashSet$_empty(type$.SynthesisResult), A.Uniquifier$(null));
              t3.SynthBuilder$2(counter, t4);
              t3 = B.JSArray_methods.join$1(t3.getFileContents$0(), "\n\n////////////////////\n\n");
              t1 = !noPrint;
              if (t1)
                A.print("/**\n * Generated by ROHD - www.github.com/intel/rohd\n * Generation time: " + t2 + "\n * ROHD Version: 0.4.1\n */\n\n" + t3);
              en._wire.inject$2$fill(0, false);
              reset._wire.inject$2$fill(1, false);
              if (t1)
                A.WaveDumper$(counter);
              A.Simulator_registerAction(25, new A.main_closure(reset));
              A.Simulator_registerAction(45, new A.main_closure0(en));
              A.Simulator_registerAction(100, new A.main_closure1(noPrint));
  ...
  A._Wire.prototype = {
    ...
    inject$2$fill(val, fill) {
      var t1 = $.$get$Simulator__injectedActions();
      t1._collection$_add$1(A._instanceType(t1)._precomputed1._as(new A._Wire_inject_closure(this, val, false)));
    },
    put$2$fill(val, fill) {
  ...
  A._Wire_inject_closure.prototype = {
    call$0() {
      return this.$this.put$2$fill(this.val, this.fill);
    },
    $signature: 0
  };
  A.Logic.prototype = {
  ...
  A.If.prototype = {
    ...
    execute$1(drivenSignals) {
      var t1, _i, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, _this = this;
      type$.Set_Logic._as(drivenSignals);
      t1 = _this.condition;
      if (_this.driverValue$1(t1).$index(0, 0).$eq(0, B._FilledLogicValue__LogicValueEnum_1_1))
        for (t1 = _this.then, _i = 0; _i < 1; ++_i)
  ...
  A._TwoInputBitwiseGate.prototype = {
    _TwoInputBitwiseGate$5$name(_op, _opStr, in0, in1, $name) {
      var t3, t4, _this = this,
        in1Logic = A.Const$(in1, in0._wire.width),
        t1 = in0.name,
        t2 = "_" + ("in0_" + t1);
  ...
  A.WaveDumper.prototype = {
    WaveDumper$2$outputPath(module, outputPath) {
      ...
      t4._collection$_add$1(A._instanceType(t4)._precomputed1._as(new A.WaveDumper_closure0(_this)));
    },
    _terminate$0() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
  ...
  A.main_closure.prototype = {
    call$0() {
      return this.reset._wire.put$2$fill(0, false);
    },
    $signature: 0
  };
  ...
  (function installTearOffs() {
    ...
    _static_1(A, "module_Module_isUnpreferred$closure", "Module_isUnpreferred", 20);
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Module, [A.Counter, A._BusSubset_Module_InlineSystemVerilog, A._SimpleClockGenerator_Module_CustomSystemVerilog, A.__Always_Module_CustomSystemVerilog, A.__TwoInputBitwiseGate_Module_InlineSystemVerilog]);
    ...
    _inherit(A.Add, A._TwoInputBitwiseGate);
